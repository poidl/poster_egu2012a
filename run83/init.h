...
#define GINT 0.0353          /*  The reduced gravity of the       */
...
#define LENLON 425987.937     /*  that are defined by AXIS_UNITS; by */
...
#define NXTOT 213               /*    NXTOT and NYTOT are the number   */
...
#define SPLIT                  /*    Use "#define SPLIT" to use the   */
                               /*  split time stepping.               */
#define DT 73.0               /* @  The time step, in s.             */
...
#define TIMEUNIT 86400.0       /*    The time unit in seconds for the */
                               /*  following fields.                  */
#define DAYMAX 1800.0           /* @  The final day of the simulation. */
...
#define INPUTDIR "/home/stefan/arbeit/gib/poster2012/run83/data"
